        ...
        <div className="relative flex-shrink-0">
            <div
                ...
                style={{
                    ...
                    color: ['yellow', 'cyan'].includes(group.color) ? '#141416' : 'white'
                }}
            >
                {collapsed ? (
            ...
            {showContextMenu && (
                <>
                    ...
                    >
                        {/* Download Section */}
                        <div className="px-3 py-1.5 text-[10px] text-[#4e4e56] uppercase tracking-wider">
                            Download
                        </div>
                        ...
                        <button
                            ...
                            className="w-full flex items-center gap-2 px-3 py-2 text-sm text-[#ededef] hover:bg-[#222225] transition-colors text-left disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            <Download className="w-4 h-4 text-[#3ecf71]" />
                        ...
                        <button
                            ...
                            className="w-full flex items-center gap-2 px-3 py-2 text-sm text-[#ededef] hover:bg-[#222225] transition-colors text-left disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            <FileText className="w-4 h-4 text-[#6e7bf2]" />
                            Download as PDF
                        </button>
                        ...
                        >
                            <Edit3 className="w-4 h-4 text-[#7a7a80]" />
                            Edit group
                        </button>
                        ...
                        <button
                            ...
                            className="w-full flex items-center gap-2 px-3 py-2 text-sm text-[#ededef] hover:bg-[#222225] transition-colors text-left"
                        >
                            <FolderOpen className="w-4 h-4 text-[#7a7a80]" />
                            Ungroup all tabs
                        </button>
